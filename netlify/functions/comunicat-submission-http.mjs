import {
    buildComunicatPayload,
} from "./comunicat-submission.mjs";
...
export async function handleComunicatSubmission(
    request,
) {
    const incoming =
...
export default async function handler(
    ...
    return handleComunicatSubmission(
        request,
    );
}
